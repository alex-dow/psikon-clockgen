...
/***
 *
 * this library is forked from https://github.com/SteveGdvs/MCP48xx
 * It is modified so I can provide my own SPI objects into it
 */
#include <Arduino.h>
#include <SPI.h>
...
template <uint8_t BITS_RES>
void MCP48xx<BITS_RES>::init(SPIClass *s)
{
  pinMode(cs, OUTPUT);
